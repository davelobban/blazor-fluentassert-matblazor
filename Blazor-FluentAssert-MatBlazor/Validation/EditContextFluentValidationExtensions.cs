...
namespace Blazor_FluentAssert_MatBlazor.Validation
{
    public static class EditContextFluentValidationExtensions
    {
        ...
        private static void ValidateModel(EditContext editContext, ValidationMessageStore messages)
        {
            ...
            //TODO Should not be casting to object
            var validationResults = validator.Validate(new ValidationContext<object>(editContext.Model));
            messages.Clear();
